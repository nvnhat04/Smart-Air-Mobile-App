    ...
    // const longitude = 105.8342; // Example longitude
      ...
      if (finalAqi === null || finalAqi === undefined) {
        try {
          ...
          // Chỉ truyền ngày hiện tại (today) cho API, không truyền ngày dự báo
      ...
      console.log('[useLocationTracking] Attempting to save current location:', { latitude, longitude, finalAqi, finalPm25 , finalAddress, today});
